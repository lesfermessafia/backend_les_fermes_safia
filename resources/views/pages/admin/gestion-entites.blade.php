                        ...
                        <tbody>
                            ...
                            <tr class="border-b hover:bg-gray-50">
                                ...
                                <td class="px-4 py-3 text-sm">
                                    <button onclick="editSite({{ $site->id }})" class="text-[#008d36] hover:text-[#305327] mr-2">Modifier</button>
                    ...
                    <table class="w-full">
                        ...
                        <tbody>
                            ...
                            <tr class="border-b hover:bg-gray-50">
                                ...
                                <td class="px-4 py-3 text-sm">
                                    <button onclick="editFerme({{ $ferme->id }})" class="text-[#008d36] hover:text-[#305327] mr-2">Modifier</button>
                    ...
                    <table class="w-full">
                        ...
                        <tbody>
                            ...
                            <tr class="border-b hover:bg-gray-50">
                                ...
                                <td class="px-4 py-3 text-sm">
                                    <button onclick="editMagasin({{ $magasin->id }})" class="text-[#008d36] hover:text-[#305327] mr-2">Modifier</button>
