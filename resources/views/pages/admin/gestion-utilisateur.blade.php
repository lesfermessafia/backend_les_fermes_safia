                        ...
                        <tr class="border-b hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3 text-sm">
                                <div class="flex gap-2">
                                    <button onclick="editUser({{ $user->id }})" class="text-blue-600 hover:text-blue-800" title="Modifier">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                        </svg>
                                    </button>
                                    @if($user->role !== 'admin')
                                        <button onclick="toggleBlock({{ $user->id }}, {{ $user->bloquer ? 0 : 1 }})" class="text-yellow-600 hover:text-yellow-800" title="{{ $user->bloquer ? 'Débloquer' : 'Bloquer' }}">
                                            @if($user->bloquer)
                                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
